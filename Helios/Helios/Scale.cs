...
namespace Helios
{
    ...
    public abstract class Scale : Panel
    {
        ...
        #region Dependency properties (general)
        ...
        #region Dependency properties (tick related)
        /*
        ...
        public static readonly DependencyProperty MinorTickStepProperty = DependencyProperty.Register(
            "MinorTickStep", 
            typeof(int), 
            typeof(Scale), 
            new PropertyMetadata(5, TickStepPropertyChanged)
            );
        ...
        public static readonly DependencyProperty MajorTickStepProperty = DependencyProperty.Register(
            "MajorTickStep",
            typeof(int), 
            typeof(Scale), 
            new PropertyMetadata(10, TickStepPropertyChanged)
            );
        ...
        public static readonly DependencyProperty MinorTickTemplateProperty = DependencyProperty.Register(
            "MinorTickTemplate", 
            typeof(DataTemplate), 
            typeof(Scale), 
            new PropertyMetadata(null, TickTemplatesChanged)
            );
