...
public class ContinuationManager
{
    ...
    bool handled = false;
    Guid id = Guid.Empty;
    //IFileOpenPickerContinuable fileOpenPickerPage;
    ...
    /// </summary>
    /// <param name="args">The activation args</param>
    /// <param name="rootFrame">The control that contains the Picker call</param>
    internal void Continue(IContinuationActivatedEventArgs args, object rootFrame)
    {
        if (args == null)
        ...
        switch (args.Kind)
        {
            case ActivationKind.PickFileContinuation:
                var fileOpenPickerPage = rootFrame as IFileOpenPickerContinuable;
            ...
            case ActivationKind.PickSaveFileContinuation:
                var fileSavePickerPage = rootFrame as IFileSavePickerContinuable;
            ...
            case ActivationKind.PickFolderContinuation:
                var folderPickerPage = rootFrame as IFolderPickerContinuable;
            ...
            case ActivationKind.WebAuthenticationBrokerContinuation:
                var wabPage = rootFrame as IWebAuthenticationContinuable;
                if (wabPage != null)
                {
