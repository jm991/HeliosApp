...
public class ContinuationManager
{
    ...
    /// </summary>
    /// <param name="args">The activation args</param>
    /// <param name="continuable">The control that contains the Picker call</param>
    internal void Continue(IContinuationActivatedEventArgs args, object continuable)
    {
        if (args == null)
        ...
        switch (args.Kind)
        {
            case ActivationKind.PickFileContinuation:
                var fileOpenPickerPage = continuable as IFileOpenPickerContinuable;
            ...
            case ActivationKind.PickSaveFileContinuation:
                var fileSavePickerPage = continuable as IFileSavePickerContinuable;
            ...
            case ActivationKind.PickFolderContinuation:
                var folderPickerPage = continuable as IFolderPickerContinuable;
            ...
            case ActivationKind.WebAuthenticationBrokerContinuation:
                var wabPage = continuable as IWebAuthenticationContinuable;
                if (wabPage != null)
                {
